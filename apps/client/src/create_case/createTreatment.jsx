...
export default function CreateTreatment(props) {
    ...
    useEffect(() => {
        const fetchTreatmentTypes = async() => {
            ...
            const treatmentTypes = await props.getCallToApi("http://localhost:5173/api/case/getTreatmentTypes", headers);
    ...
    const fetchSubtypes = async (id) => {
        ...
        const response = await props.getCallToApi('http://localhost:5173/api/case/getTreatmentSubtypes', headers);
